...
root_dir = '/home/mii2/project/cy/Transformer会议/video_data/uex_class4_slowfast_feature'
...
state_dict_path_list = ["/home/mii2/project/cy/Transformer会议/model/uex_class4/type4-16×8×8×8-fold1.pt",
                        "/home/mii2/project/cy/Transformer会议/model/uex_class4/type4-16×8×8×8-fold2.pt",
                        "/home/mii2/project/cy/Transformer会议/model/uex_class4/type4-16×8×8×8-fold3.pt",
                        "/home/mii2/project/cy/Transformer会议/model/uex_class4/type4-16×8×8×8-fold4.pt"]

k_index = 0
skf = StratifiedKFold(n_splits=4, random_state=528)
for i in range(4):
    ...
    path = 'fold-'+str(k_index)+'-cm-all-sample.png'
